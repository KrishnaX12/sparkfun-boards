...
export default () => (
  <board outline={outline}>
    ...
    {/* Eagle schematic title block reference */}
    <schematictext
      text="⚙ open hardware"
      schX={5.4}
      schY={-5.55}
    ...
    />
    <schematictext
      text="Released under the Creative Commons"
      schX={5.3}
      schY={-6.05}
      fontSize={0.12}
      color="brown"
    />
    <schematictext
      text="Attribution Share-Alike 4.0 License"
      schX={5.3}
      schY={-6.25}
      fontSize={0.12}
      color="brown"
    ...
    />
    <schematictext
      text="TITLE: ATX_Power_Connector_Breakout"
      schX={5.3}
      schY={-6.85}
      fontSize={0.18}
      color="brown"
    />
    <schematictext
      text='Design by: Ho Yun "Bobby" Chan'
      schX={5.3}
      schY={-7.25}
      fontSize={0.16}
      color="brown"
